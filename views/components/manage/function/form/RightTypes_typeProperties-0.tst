...
<tr>
    <td class="manage_form_table_label_cell">Code:</td>
    <td class="manage_form_table_input_cell"><input type="text" name="code" value="<%= $f->{code} %>" size="50" maxlength="50" /></td>
</tr>
<tr>
    <td class="manage_form_table_label_cell">Display Label:</td>
    <td class="manage_form_table_input_cell"><input type="text" name="display_label" value="<%= $f->{display_label} %>" size="100" maxlength="100" /></td>
</tr>
<tr>
