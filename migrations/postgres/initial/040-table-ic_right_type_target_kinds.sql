...
schema	schema	user	User	IC::M::RightTarget::User	users
schema	schema	role	Role	IC::M::RightTarget::Role	roles
schema	schema	site_mgmt_func	Site Mgmt Function	IC::M::RightTarget::SiteMgmtFunc	manage_functions
\.
