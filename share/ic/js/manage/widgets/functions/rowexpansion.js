YUI.add('rowexpansion', function(Y) {
    if (Y.YUI2) {
        var YAHOO = Y.YUI2;
    }
    ...
    ***********/
    ...
    YAHOO.register("rowexpansion", YAHOO.widget.RowExpansionDataTable, {version: "2.8.0r4", build: "2446"});

    if (!Y.YUI2) {
        Y.YUI2 = YAHOO;
    }
    if (!YAHOO._activ && YAHOO.widget.RowExpansionDataTable) {
        YAHOO._activ = true;
        YAHOO.widget.RowExpansionDataTable._load();
    }
}, '2.8.0' ,{"requires": ["yui2-yahoo", "yui2-datatable"]});
