...
# This needs to do something that would throw a Safe error if Safe were in use
package Foo::Object;
...
cmp_ok(
    ...
    'eq',
    "x: \ny: ",
    'render: insure marshalled data does not bleed through iterations',
);
