...
=cut
package IC::C::Manage::Widget::Tools::QuickAccess;
...
#__PACKAGE__->registered_name('manage/widget/tools/quick_access');

sub data {
    #warn "IC::C::Manage::Widget::Tools::QuickAccess::data";
    my $self = shift;
